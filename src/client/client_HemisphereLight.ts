...
const data = {
  color: light.color.getHex(), // ! for a 'sky' light, we can still use the color property
  groundColor: light.groundColor.getHex(), // ! Hemisphere Light has this extra property, useful for simulating a ground color, so object can receive these lights reflection
  mapsEnabled: true,
};
