...
// ! In this image, lighter colors will be higher and darker colors will be lower vertices
...
// ! When reflectivity and refractonRadion is 0, displacementScale will inclinate the plane image by the y axis; When their are about 1 AND the widthSegments and heightSegments os > than 0, displacementScale will increase or decrease the the plane image vertices
meshPhongMaterialFolder.add(material, "displacementBias", -1, 1, 0.01);
// ! displacementBias will move the plane image foward and backward by the z axis
