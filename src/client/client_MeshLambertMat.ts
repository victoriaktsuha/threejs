...
// ! Lambertian reflectance is the property that defines an ideal matte or diffusely reflecting surface. sExamples may be wood, or stone. Generally objects that aren't shiny, but are still affected by lighting.
...
//meshLambertMaterialFolder.add(material, 'flatShading').onChange(() => updateMaterial()) // ! deprecated
