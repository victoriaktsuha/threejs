...
/*
Here is an example of an animated GLTF being manipulated with transform controls.

In this example, you can transform the animated models position, rotation and size.
*/
