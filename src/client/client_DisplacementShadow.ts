...
/*
Since Three r132, displacement maps now support self shadowing. Ensure your mesh, e.g., a plane, is both casting and receiving shadows. You will need to manage the light.shadow.bias if you see shadow artifacts.

This example is using the directional light shadow with the MeshStandardMaterial
*/
