...
// ! UV is lke X and Y in 2D plane - The letters "U" and "V" denote the axes of the 2D texture because "X", "Y", and "Z" are already used to denote the axes of the 3D object in model space, while "W" (in addition to XYZ) is used in calculating quaternion rotations, a common operation in computer graphics. - https://en.wikipedia.org/wiki/UV_mapping
...
// ! One way to increase the resolution is to create a geometry with more vertices 360,180 => 1440,720
...
textureFolder
  // ! reducing the size of the X and Y repeated texture (ratio 1:1 - center), draw a smaller section of the material and can gives us more details
...
textureFolder.open();
// ! increasing/decreasing X and Y centered texture draw a piece of the displacement map

// ! these changes can gives us more resolution without hardcoding in the geometry method
