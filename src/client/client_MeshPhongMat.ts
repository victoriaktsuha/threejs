...
// ! It uses the Blinn–Phong reflection model,It is useful for simulating shiny objects such as polished wood. It is more computationally-expensive to use than the MeshLambertMaterial, MeshNormalMaterial and MeshBasicMaterial so if performance needs to be considered, then one option you have is to only use it when necessary.
// ! It is useful for simulating shiny objects such as polished wood, but it'
