...
// ! It uses the Physically Based Rendering (PBR) model. It creates a more realistic appearance than the MeshLambertMaterial or the MeshPhongMaterial. It is also more computationally expensive.
