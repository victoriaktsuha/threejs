...
/*
Anisotropic Filtering allows us to improve the quality of the MIP maps. It reduces the width and the height by half each time it goes across and goes down, respectivelly
...
// ! the effect of the anisotropy in images as texture isn: higher the anisotropy, flickery the further texture; lower the anisotropy, smoother/blurrier the further texture
...
// ! Higher the anisotropy, further the texture (colors) will be drawn
textureFolder.open();
