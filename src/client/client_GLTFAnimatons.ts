...
/*
we will create the GLTF equivalent of the project created in the FBX animations lesson.

We use Blender to convert the main FBX model, and it's related animation files, into GLB files (slightly lighter than FBX).
*/
