...
const mipmap = (size: number, color: string) => {
  ...
  context.fillStyle = "#888888"; // ! the gray color of the bg
...
// ! here is created the function responsible for the squares in the board

const blankCanvas = document.createElement("canvas") as HTMLCanvasElement;
blankCanvas.width = 128;
blankCanvas.height = 128;
// ! here we define the initial size of the board
...
// ! Instead the usual texture image, here we define a color for each size of the board and repeat the
